    ...
    <SubALayout leadHeader='CZĘŚĆ A – INFORMACJE DOTYCZĄCE UCZNIA/UCZENNICY'>
      ...
      <Container textAlign='left' fluid>
        ...
        <Accordion fluid styled>
          ...
          <Accordion.Content active={curDocument?.isTab1b}>
            <Form className='form-vii'>
              <TextArea
                value={curDocument?.tab1b_desc}
                onChange={(e) => handleOnChange(e)}
                name='tab1b_desc'
                data-name='tab1b_desc'
          ...
          <Accordion.Content active={curDocument?.isTab1c}>
            <Form className='form-vii'>
              <TextArea
                value={curDocument?.tab1c_desc}
                onChange={(e) => handleOnChange(e)}
                name='tab1c_desc'
                data-name='tab1c_desc'
                placeholder='Wpisz temat pracy badawczej'
                className='form-textArea'
              ></TextArea>
            </Form>
