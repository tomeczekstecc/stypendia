export const prepareTempleResetPass = (token) => {
  const base = `
<!doctype html>
                                ...
                                <tbody>
                                  <tr  style="text-align:center">
                                    ...
                                    <td valign="top" class="mcnTextContent"
                                      ...
                                      <h2><span style="font-size:28px; text-align: center">Resetowanie hasła</span><br>
                                ...
                                <tbody>
                                  <tr>
                                    ...
                                    <td valign="top" class="mcnTextContent"
                                      ...
                                      <p>Otrzymasliśmy Twoją prośbę zmiany hasła.Nie ma sprawy!!!</p>

                                      <p>Wystarczy że klikniesz klikniesz przycisk...</p>
                                ...
                                <tbody>
                                  <tr>
                                    <td align="center" valign="middle" class="mcnButtonContent"
                                      ...
                                      <a title="Resetuję hasło" href="${token}" target="_blank"
                                        style="font-weight: bold;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">Resetuję hasło</a>
                                    </td>
                                  </tr>
                                </tbody>
                              </table>
