export const msg = {
  ...
  client: {
    fail: {
      ...
      blocked:
        'Odnotowano zbyt dużą liczbę nieudanych logowań. Użytkownik jest zablokowany. Spróbuj za 20 minut',
      forcedChangePass:
      ...
      virusDet: 'Ten plik jest podejrzany. Złącznik nie został utworzony.'
    },
    ok: {
