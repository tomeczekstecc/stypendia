export const prepareTempleVerify = (link) => {
  const base = `
<!doctype html>
            ...
            <tr>
              <td align="center" valign="top" id="templateHeader" data-template-container>
                                  ...
                                  <tr>
                                    <td class="mcnImageContent" valign="top"
                                      ...
                                      <img align="center" alt=""
                                        src="https://mcusercontent.com/c4508f8e951a48b5c606f1c24/images/7021adcf-8c9a-4c83-b08b-ac3fa0b93985.png"
                                        width="80"
                                        style="max-width:125px; padding-bottom: 0; display: inline !important; vertical-align: bottom;"
                                        class="mcnImage">
				...
				<![endif]-->
                              ...
                              <!--[if mso]>
				<td valign="top" width="600" style="width:600px; text-align:center">
				<![endif]-->
                                ...
                                <tbody>
                                  <tr  style="text-align:center">
                                    ...
                                    <td valign="top" class="mcnTextContent"
                                      style="padding: 0px 18px 9px;color: #4CAAD8;font-family: Lato, ";Helvetica Neue";, Helvetica, Arial, sans-serif;font-style: normal;font-weight: normal;line-height: 115%;text-align: center">

                                      <h2><span style="font-size:28px; text-align: center">Potwierdzenie adresu email na</span><br>
                                        <span style="font-size:37px; text-align: center">slaskietalenty.com</span></h2>
                                ...
                                <tbody>
                                  <tr>
                                    ...
                                    <td valign="top" class="mcnTextContent"
                                      ...
                                      <p>Pozostało jeszcze potwierdzenie&nbsp;adresu email, tak dla pewności - to już
                                        ostatnia formalność. Wystarczy, że klikniesz na przycisk...</p>
                                ...
                                <tbody>
                                  <tr>
                                    <td align="center" valign="middle" class="mcnButtonContent"
                                      style="font-family: Lato,sans-serif; font-size: 18px; padding: 18px;">
                                      <a title="Potwierdzam email" href="${link}" target="_blank"
                                        style="font-weight: bold;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">Potwierdzam
                                        email</a>
                                    </td>
                                  </tr>
                                </tbody>
                                ...
                                <tbody>
                                  <tr>
                                    ...
                                    <![endif]-->
                                      ...
                                      <p style="color: white;font-family: 'Lato', sans-serif;font-size: 12px;">STRONA
                                        PROJEKTU</p>
                                    </td>
                                  </tr>
                                </tbody>
                                ...
                                <tbody>
                                  <tr>
                                    ...
                                    <td valign="top" class="mcnTextContent"
                                      ...
                                      <em>Katowice 2021 | slaskietalenty.com, Wszelkie prawa zastrzerżone.</em><br>
                                      <br>
                                      <strong>Siedziba Zespołu ds. realizacji projektu pn. "Śląskie. Inwestujemy w
                                        talenty":</strong><br>
                                      Katowice, ul. Dąbrowskiego 23, p. 4.22-4.24<br>
                                      <br>
                                      <p> Urząd Marszałkowski Województwa Śląskiego
                                        ul. Ligonia 46, 40-037 Katowice</p>
                                    </td>
                                  </tr>
                                </tbody>
                              </table>
